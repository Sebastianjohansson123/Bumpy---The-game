...
function preload() {
  images = {
    backgrounds: [
      loadImage("./assets/images/backgrounds/bg01.png"),
      loadImage("./assets/images/backgrounds/bg02.png"),
      loadImage("./assets/images/backgrounds/bg03.png"),
      loadImage("./assets/images/backgrounds/bg04.png"),
      loadImage("./assets/images/backgrounds/bg05.png"),
      loadImage("./assets/images/backgrounds/bg06.png"),
      loadImage("./assets/images/backgrounds/bg07.png"),
      loadImage("./assets/images/backgrounds/bg08.png"),
      loadImage("./assets/images/backgrounds/bg09.png"),
